...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhobWF0aGFzdHJvbm9teSIsImEiOiJjbDNrYnp5djYxY2htM2lsajNsZjJpNDE5In0.qSSOoXsVC7BQo25vae1-zQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/thhmathastronomy/cl3kizvbu001j14qjcvymz1yr',
    scrollZoom: false
  });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); // !!! Force a reload to server, not just browser cache
...
var stripe = Stripe('pk_test_51L84Z6DneKUwHg1tswPh8xuIWLX4nmXBGeO4aDnDhFIpDnQYATvjUWqukDtTUE75pAqO0ZahUAMBONn6dCM1uJ6c00RGV5lIfw');
